...
/// with [SpringDescription] passing,you can custom spring back animate,the more paramter can be setting in [RefreshConfigScope]
///
/// see also:
///
/// * [RefreshConfigScope], a configuration for Controlling how SmartRefresher widgets behave in a subtree
