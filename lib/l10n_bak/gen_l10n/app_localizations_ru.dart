...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get displayPerformanceFloatingLayer =>
      'Показать плавающий слой производительности';
  ...
  String get afterOpeningWillFollowTheSystemToOpenOrCloseDarkMode =>
      'После включения будет следовать за системой для включения или отключения тёмного режима';
  ...
  String get viewThisProjectGithubRepository =>
      'Посмотреть репозиторий проекта на Github';
  ...
  String get basicDrawingDesc =>
      'Включает несколько примеров базового рисования, которые будут полезны для начинающих программистов. Эти примеры научат рисованию базовых фигур, таких как точки, линии, прямоугольники, круги и текст.';
  ...
  String get animationGestureDesc =>
      'Содержит примеры рисования анимаций и жестов, которые сделают рисование более интерактивным. Эти примеры научат использовать анимации и жесты, такие как скольжение, вращение, масштабирование и перемещение.';
  ...
  String get particleDrawingDesc =>
      'Включает примеры рисования с использованием частиц. Эти примеры покажут, как использовать частицы для создания зрелищных эффектов, таких как взрывы или анимации с частицами.';
  ...
  String get interestingDrawingDesc =>
      'Примеры интересных и забавных рисунков, где мы можем наслаждаться процессом рисования и программирования.';
  ...
  String get artGalleryDesc =>
      'Содержит примеры высокого искусства, которые не предназначены для практических целей, а являются выражением человеческого интеллекта и творчества.';

  @override
  String get drawingOfImages =>
      'Пример рисования изображений: загрузка изображения и его отрисовка в определенной области. На верхнем слое добавлены линии сетки для практики рисования линий.';

  @override
  String get digitalDisplayTube =>
      'Пример рисования цифровых трубок с использованием пути Path и анимации.';
  ...
  String get gridCoordinateSystem =>
      'Пример рисования сетки координат с линиями и текстом для новичков.';

  @override
  String get polarCoordinateSystemOfFaces =>
      'Пример рисования полярной координатной системы с использованием функций.';

  @override
  String get drawFunctionCurvesForPathPairs =>
      'Пример рисования функциональных кривых с использованием пути и Беезье.';

  @override
  String get drawRegularPolygons =>
      'Пример рисования правильных многоугольников внутри круга.';

  @override
  String get randomNumberProcessing =>
      'Пример рисования прямоугольников с обработкой случайных чисел.';
  ...
  String get drawSprings =>
      'Пример рисования пружины с анимацией сжатия и растяжения.';

  @override
  String get theApplicationOfAnglesInDrawing =>
      'Пример рисования с использованием углов для вращения.';

  @override
  String get usingShadersAndFilters =>
      'Пример использования шейдеров и фильтров для создания анимации.';

  @override
  String get pathDrawingFunctionCurve =>
      'Пример рисования кривых с помощью пути и измерения анимации.';

  @override
  String get thePathOfBingDwenDwen =>
      'Пример рисования пути маскота Олимпиады Пекин-2022 с использованием анимации пути.';

  @override
  String get drawCubicBesselCurve =>
      'Пример рисования кривой кубического Безье с возможностью перетаскивания точек.';

  @override
  String get theEffectOfAnimationCurve =>
      'Пример демонстрации эффекта анимационной кривой для углубленного понимания анимаций.';

  @override
  String get randomParticlesAndBoundaryBouncing =>
      'Пример создания случайных частиц с отскоком от границ.';

  @override
  String get particleCollision =>
      'Пример столкновений частиц с анимацией их распада.';
  ...
  String get rectangleAndRandomNumbers =>
      'Пример рисования прямоугольников с использованием случайных чисел.';

  @override
  String get bingDwenDwen =>
      'Пример рисования формы маскота Олимпиады Пекин-2022.';

  @override
  String get pufengInjectionTest =>
      'Пример теста для вычисления числа Пи с использованием вероятности.';

  @override
  String get ticTacToe =>
      'Пример игры в крестики-нолики с логикой и анимацией.';

  @override
  String get tiledLines =>
      'Пример, основанный на генеративном искусстве, реализованный с помощью Flutter.';
  ...
  @override
  String get qAIssues =>
      'Данные QA из сборника важных моментов rUnit будут добавлены в issues с меткой point.';
  ...
  String get pleaseSelectOrInputIconfontCompressedPackagePath =>
      'Пожалуйста, выберите или введите путь к сжатому пакету iconfont';
  ...
  String get backupFavoritesCollectionData =>
      'Резервное копирование данных избранного';
  ...
  String get dataSetBackupSuccess =>
      'Резервное копирование данных прошло успешно!';
  ...
  String get emptySearch =>
      'Данных нет, я тоже не знаю, что делать\n(≡ _ ≡)/~┴┴';
