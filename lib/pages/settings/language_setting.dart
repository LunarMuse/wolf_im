...
class LanguageSettingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(context.l10n.settingLanguage)),
...
class LanguageSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Language activeLanguage = context.select<AppConfigBloc, Language>(
      (bloc) => bloc.state.language,
    );
...
class LanguageSwitchTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Text(
        context.l10n.settingLanguageText,
