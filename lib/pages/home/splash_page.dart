...
/// 说明: app 闪屏页
class WolfIMSplash extends StatelessWidget {
  const WolfIMSplash({super.key});
...
class _SplashBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        const SplashTopBar(
          leading: Text('Flutter Unit Splash', style: titleStyle),
          logo: CircleAvatar(
            ...
            children: [
              Positioned(
                ...
                child: Wrap(
                  ...
                  crossAxisAlignment: WrapCrossAlignment.center,
                  children: [
                    Text("这是启动页Power By 张风捷特烈", style: shadowStyle),
