...
class AppTextStyle {
  ...
  static const shadowTextStyle = TextStyle(
    color: Colors.grey,
    shadows: [
  ...
  static const commonChip = TextStyle(fontSize: 12, color: Colors.white);
  ...
  static const TextStyle primary = TextStyle(
    color: UnitColor.text_color,
    fontSize: SizeUnit.input_text_size,
  );

  static const TextStyle headTextStyle = TextStyle(
    color: UnitColor.head_text_color,
    fontSize: SizeUnit.head_text_size,
  );
  ...
  static const TextStyle bigTextStyle = TextStyle(
    color: UnitColor.text_color,
    fontSize: SizeUnit.big_text_size,
  );
}
